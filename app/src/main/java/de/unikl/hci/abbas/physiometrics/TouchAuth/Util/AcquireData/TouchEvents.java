...
import de.unikl.hci.abbas.physiometrics.TouchAuth.Util.ArrayUtil;
import de.unikl.hci.abbas.physiometrics.TouchAuth.MLModel.FeatureVector;
import de.unikl.hci.abbas.physiometrics.TouchAuth.Util.Jama.Complex;

import java.util.ArrayList;

public abstract class TouchEvents extends Generator {
    ...
    protected FeatureVector computeFeatureVector(ArrayList<TouchPoint> touchPoints) {
		...
		/*F8-15*/
        fv.set(6, Complex.circ_r(pairwAngle)); /*meanResultantLength*/
        ...
        fv.set(13, Math.atan2(fv.get(3) - fv.get(1), fv.get(2) - fv.get(0))); /*lineDirection*/
    ...
    // Touch the point class to facilitate the calculation of eigenvectors
